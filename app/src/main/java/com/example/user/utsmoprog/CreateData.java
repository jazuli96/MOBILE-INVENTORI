    ...
    public void onClick(View v) {
        ...
        switch(v.getId())
        {
            case R.id.buttom_submit:
                ...
                Toast.makeText(this, "Sukses Tambah Barang\n" +
                        "Nama Barang : " + barang.getNama_barang() +
                        "\nMerk Barang : " + barang.getMerk_barang() +
                        "\nHarga Barang : " + barang.getHarga_barang(), Toast.LENGTH_LONG).show();
                break;
        }
